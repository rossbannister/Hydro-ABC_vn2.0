...
REAL(ZREAL8)                          :: rhopsumtemp
REAL(ZREAL8), ALLOCATABLE             :: rhopsum(:)
REAL(ZREAL8), ALLOCATABLE             :: rhobound(:)
REAL(ZREAL8), ALLOCATABLE             :: diff(:)
REAL(ZREAL8)                          :: ux, uxm1, px, px1, pxm1, pxp1, deltaz, dpdz
REAL(ZREAL8)                          :: theta_sum
REAL(ZREAL8), ALLOCATABLE             :: theta_z(:)
REAL(ZREAL8), ALLOCATABLE             :: pprimed(:,:)
REAL(ZREAL8)                          :: pav
REAL(ZREAL8), ALLOCATABLE             :: rhoprimed(:,:)
REAL(ZREAL8), ALLOCATABLE             :: rhoav(:)
REAL(ZREAL8)                          :: rho0
REAL(ZREAL8)                          :: C_um
...
ALLOCATE (rhopsum(1:nlevs))
ALLOCATE (rhobound(1:nlevs))
ALLOCATE (diff(1:nlevs+1))
ALLOCATE (theta_z(1:nlevs))
ALLOCATE (pprimed(1:nlongs,1:nlevs))
ALLOCATE (rhoprimed(1:nlongs,1:nlevs))
ALLOCATE (rhoav(1:nlevs))
...
DEALLOCATE (rhopsum, rhobound, diff, theta_z, pprimed, rhoprimed, rhoav)
