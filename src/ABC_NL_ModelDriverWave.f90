SUBROUTINE ABC_NL_ModelDriverWave ( StateIn, dims, ntimesteps, ndumps,   &
...
INTEGER,         INTENT(IN)    :: store_level
REAL(ZREAL8),    INTENT(INOUT) :: store(1:nlongs, 0:ntimesteps)
...
store(1:nlongs, 0) = StateA % horiz_vort(1:nlongs, store_level)
...
DO t = 1, ntimesteps
 ! PRINT*,' > ', t, ' of ', ntimesteps
  ...
  store(1:nlongs, t) = StateB % horiz_vort(1:nlongs, store_level)
...
END SUBROUTINE ABC_NL_ModelDriverWave
