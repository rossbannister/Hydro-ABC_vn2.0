...
REAL(ZREAL8), ALLOCATABLE :: mall(:)
REAL(ZREAL8), ALLOCATABLE :: kall(:)     
REAL(ZREAL8)              :: L(1:5, 1:5)              
REAL(ZREAL8)              :: lambda(1:5)              
REAL(ZREAL8)              :: Work(1:14)
REAL(ZREAL8), ALLOCATABLE :: grav_frequency (:,:)    
REAL(ZREAL8), ALLOCATABLE :: acou_frequency (:,:)    
REAL(ZREAL8), ALLOCATABLE :: hori_grav_speed(:,:)    
REAL(ZREAL8), ALLOCATABLE :: hori_acou_speed(:,:)    
REAL(ZREAL8), ALLOCATABLE :: vert_grav_speed(:,:)    
REAL(ZREAL8), ALLOCATABLE :: vert_acou_speed(:,:)    
INTEGER                   :: k, m, i, j
INTEGER                   :: ierr
...
ALLOCATE (mall(0:nlevs-1))
ALLOCATE (kall(0:nlongs-1))     
ALLOCATE (grav_frequency (0:nlongs-1, 0:nlevs-1))
ALLOCATE (acou_frequency (0:nlongs-1, 0:nlevs-1))
ALLOCATE (hori_grav_speed(0:nlongs-1, 0:nlevs-1))
ALLOCATE (hori_acou_speed(0:nlongs-1, 0:nlevs-1))
ALLOCATE (vert_grav_speed(0:nlongs-1, 0:nlevs-1))
ALLOCATE (vert_acou_speed(0:nlongs-1, 0:nlevs-1))
...
DEALLOCATE (mall, kall)
DEALLOCATE (grav_frequency, acou_frequency, hori_grav_speed, hori_acou_speed, vert_grav_speed, vert_acou_speed)
